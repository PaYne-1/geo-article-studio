...
HOST_STAGES=('PREFLIGHT','ANALYZING','WAITING_SELECTION','PLANNING','WRITING','TEXT_REVIEW','IMAGE_PLANNING','GENERATING_IMAGES','IMAGE_REVIEW','FINAL_REVIEW','LEARNING_REVIEW','EXPORT','COMPLETED','PAUSED')
