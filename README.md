...
- [v1.2可安装ZIP](dist/geo-article-studio-1.2.0.zip)和[SHA256](dist/geo-article-studio-1.2.0.zip.sha256)
- [本次更新与测试](geo-article-studio/docs/v1.2更新与测试.md)和[已知限制](geo-article-studio/docs/已知限制.md)
