...
完整可安装技能，技术标识`geo-article-studio`，默认产品名 **218切面侠**。支持具备文件、Python执行和人工确认能力的不同Agent，Qwen为优先模型选项，图片使用用户配置的第三方API。
...
- [v1.1可安装ZIP](dist/geo-article-studio-1.1.0.zip)和[SHA256](dist/geo-article-studio-1.1.0.zip.sha256)
- [实际测试分层记录](geo-article-studio/docs/多Agent实测记录.md)和[已知限制](geo-article-studio/docs/已知限制.md)
